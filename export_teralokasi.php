...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA TERALOKASI"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->setActiveSheetIndex(0)->setCellValue('A3', "TIPE"); // Set kolom A3 dengan tulisan "NO"
...
$sql = $pdo->prepare("SELECT norangka,nomesin,harga_jual,tahun_buat,tglbeli,nopenjualan,tglmatching,kode_model,nama_model,kode_tipe,nama_tipe,kode_warna,nama_warna
						    ,kode_sales,nama_sales,nomatching,nofaktur,status
						    FROM data_mobil
...
while($data = $sql->fetch()){ // Ambil semua data dari hasil eksekusi $sql
  $excel->setActiveSheetIndex(0)->setCellValue('A'.$numrow, $nama_tipe);
