...
if (empty($_GET[filter])){
	...
	$filter_pencarian = "&filter=$_GET[filter]";
...
if($halaman_aktif > 1){
	...
	$link_halaman .= "<li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&status_approved=$_GET[status_approved]&tgl_awal=$_GET[tgl_awal]&tgl_akhir=$_GET[tgl_akhir]&batas=$_GET[batas]$filter_pencarian&halaman=1><i class='ti-angle-left'></i><i class='ti-angle-left'></i></a></li> 
                    <li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&status_approved=$_GET[status_approved]&tgl_awal=$_GET[tgl_awal]&tgl_akhir=$_GET[tgl_akhir]&batas=$_GET[batas]$filter_pencarian&halaman=$prev><i class='ti-angle-left'></i></a></li> ";
}
else{ 
	$link_halaman .= "<li class='disabled'>
																<a ><i class='ti-angle-left'></i><i class='ti-angle-left'></i></a>
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&status_approved=$_GET[status_approved]&tgl_awal=$_GET[tgl_awal]&tgl_akhir=$_GET[tgl_akhir]&batas=$_GET[batas]$filter_pencarian&halaman=$i>$i</a></li> ";
  }
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "<li><a>...</a></li> <li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&status_approved=$_GET[status_approved]&tgl_awal=$_GET[tgl_awal]&tgl_akhir=$_GET[tgl_akhir]&batas=$_GET[batas]$filter_pencarian&halaman=$jmlhalaman>$jmlhalaman</a> </li>  " : " ");
...
if($halaman_aktif < $jmlhalaman){
	...
	$link_halaman .= " <li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&status_approved=$_GET[status_approved]&tgl_awal=$_GET[tgl_awal]&tgl_akhir=$_GET[tgl_akhir]&batas=$_GET[batas]$filter_pencarian&halaman=$next><i class='ti-angle-right'></i></a> </li> 
                     <li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&status_approved=$_GET[status_approved]&tgl_awal=$_GET[tgl_awal]&tgl_akhir=$_GET[tgl_akhir]&batas=$_GET[batas]$filter_pencarian&halaman=$jmlhalaman><i class='ti-angle-right'></i><i class='ti-angle-right'></i></a></li> ";
}
else{
	$link_halaman .= "<li class='disabled'>
																<a ><i class='ti-angle-right'></i></a>
															</li><li class='disabled'>
																<a ><i class='ti-angle-right'></i><i class='ti-angle-right'></i></a>
															</li> ";
}
