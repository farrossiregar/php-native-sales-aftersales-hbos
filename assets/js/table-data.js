var TableData = function() {
	...
	var runDataTable_example1 = function() {
		...
		$('#sample_1_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Filter Pencarian");
	...
	var runDataTable_example3 = function() {
		...
		$('#sample_3_wrapper_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
		$('#sample_3_wrapper_wrapper .dataTables_length select').addClass("m-wrap small");
		// modify table per page dropdown
	...
	var runDataTable_example4 = function() {
		...
		$('#sample_4_wrapper_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
	...
	var runDataTable_example6 = function() {
		...
		$('#sample_6_wrapper_wrapper_wrapper_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
	...
	var runDataTable_example7 = function() {
		...
		$('#sample_7_wrapper_wrapper_wrapper_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
	...
	var runDataTable_example8 = function() {
		...
		$('#sample_8_wrapper_wrapper_wrapper_wrapper_wrapper_wrapper_wrapper_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
