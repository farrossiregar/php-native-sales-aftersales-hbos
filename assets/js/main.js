	...
	var settingsHandler = function() {
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "res/img/sos-bos.png");
					break;

				default:
					$(".navbar-brand img").attr("src", "res/img/sos.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "assets/css/themes/theme-2.css");
			$(".navbar-brand img").attr("src", "assets/images/logo_honda.png");
