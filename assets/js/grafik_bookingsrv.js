var Charts = function() {"use strict";
	...
	//	var res = new Array("50", "25","33","62","49","37","72");
		...
		var dd = total_booking.toString();
		var d = dd.trim();
		var dat = d.split(",");
		
		
		var dd1 = total_booking.toString();
		var d1 = dd1.trim();
		var dat1 = d1.split(",");
		
		var dd2 = total_datang.toString();
		var d2 = dd2.trim();
		var dat2 = d2.split(",");
		
		
		var dd3 = total_tdk_datang.toString();
		var d3 = dd3.trim();
		var dat3 = d3.split(",");
		
		var dd4 = total_reschedule.toString();
		var d4 = dd4.trim();
		var dat4 = d4.split(",");
		
		var dd5 = total_cancel.toString();
		var d5 = dd5.trim();
		var dat5 = d5.split(",");
		
		
		var data = {
			labels: ["BOOKING", "DATANG", "TIDAK DATANG", "RESCHEDULE", "TOTAL CANCEL"],
			datasets: [{
				label: "TOTAL : BOOKING, DATANG, TIDAK DATANG, RESCHEDULE, TOTAL CANCEL",
				fillColor: "rgba(151,187,205,0.5)",
				strokeColor: "rgba(151,187,205,0.8)",
				highlightFill: "rgba(151,187,205,0.75)",
				highlightStroke: "rgba(151,187,205,1)",
				data: [total_booking, total_datang, total_tdk_datang, total_reschedule, total_cancel]
			}]
		};
