var Charts = function() {"use strict";
	...
	var barChartHandler = function() {
		...
		//var nama_sa = "a,b,c,d,e,f,g,h,i,j";
		//var string_sa = nama_sa.toString();
		//var trim_sa = string_sa.trim();
	
		//var split_nama_sa = nama_sa.split(",");
		
		
		
		var data = {
			//labels: ["BRIO", "MOBILIO", "BR-V", "HR-V", "JAZZ", "CITY", "CIVIC", "CR-V", "ACCORD", "ODYSSEY"],
			labels : nama_sa.split(","),
			datasets: [{
				label: "Nama SA",
	...
	var lineChartHandler3 = function() {
		var options = {
			// Sets the chart to be responsive
			responsive: true,
	...
	//	var target_ss = target_sudi +","+
		...
		var legend = lineChart.generateLegend();
		//and append it to your page somewhere
		$('#lineLegend3').append(legend);
	};
	
	var lineChartHandler4 = function() {
		var options = {
			// Sets the chart to be responsive
			responsive: true,
