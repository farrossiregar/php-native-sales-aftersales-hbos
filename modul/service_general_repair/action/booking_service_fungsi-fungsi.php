		...
		$(document).ready(function(){
						$('#src').click(function(){
							...
							if (nopolisi != ""){
								...
								$.ajax({
										method : "post",
										url : "modul/service_general_repair/action/booking_service_tampil_data_mobil.php",
										...
										success : function(data){
											...
											if (hasil['status']=="kosong"){
												...
												$('#telepon').val(hasil['nohp']);
												$('#norangka').val(hasil['norangka']);
												$('#nomesin').val(hasil['nomesin']);
												$('#nama_cust').val(hasil['nama']);
												
												
												if (tipe == 'ACCORD'){
													document.getElementById("tipe").selectedIndex = "1";
												}else if (tipe == 'BRIO'){
													document.getElementById("tipe").selectedIndex = "2";
												}else if (tipe == 'CITY'){
													document.getElementById("tipe").selectedIndex = "3";
												}else if (tipe == 'CIVIC'){
													document.getElementById("tipe").selectedIndex = "4";
												}else if (tipe == 'CR-V'){
													document.getElementById("tipe").selectedIndex = "5";
												}else if (tipe == 'BR-V'){
													document.getElementById("tipe").selectedIndex = "6";
												}else if (tipe == 'HR-V'){
													document.getElementById("tipe").selectedIndex = "7";
												}else if (tipe == 'JAZZ'){
													document.getElementById("tipe").selectedIndex = "8";
												}else if (tipe == 'MOBILIO'){
													document.getElementById("tipe").selectedIndex = "9";
												}else if (tipe == 'ODYSSEY'){
													document.getElementById("tipe").selectedIndex = "10";
												}else if (tipe == 'FREED'){
													document.getElementById("tipe").selectedIndex = "11";
												}else if (tipe == 'STREAM'){
													document.getElementById("tipe").selectedIndex = "12";
												}else if (tipe == 'CR-Z'){
													document.getElementById("tipe").selectedIndex = "13";
												}else if (tipe == 'ELLYSON'){
													document.getElementById("tipe").selectedIndex = "14";
												}
					...
					function tambah_data(){
						...
						$.ajax({
							method : "post",
							url : "modul/service_general_repair/action/booking_service_no_booking.php",
							success : function(data){
								$("Modal2").modal('show');
					...
					function cari_data_booking(){
						...
						if ($('#periode_booking').val() != ''){
							$.ajax({
								method : "post",
								url : "modul/service_general_repair/action/booking_service_tampil_data_booking.php",
								...
								success : function(data){
									...
									$('#header_table').show();
									$('#export').attr('href', 'modul/service_general_repair/action/booking_service_export_data_booking.php?periode_booking='+tanggal);
								}
							})
						}
						if ($('#search').val() == ""){
					...
					function pilih_hari(){
						...
						$.ajax({
							method : "post",
							url : "modul/service_general_repair/action/booking_service_get_hari.php",
					...
					function isi_jenis_service(perbaikan,jenisperbaikan){
						...
						$.ajax({
							method : "post",
							url : "modul/service_general_repair/action/booking_service_isi_jenis_service.php",
					...
					function edit_modal($id){
						...
						$.ajax({
							method : "post",
							url : "modul/service_general_repair/action/booking_service_edit_data.php",
					...
					function update_booking(){
						...
						//	var periode = $('#periode_booking').val();
							...
							$.ajax({
								method : "post",
								url : "modul/service_general_repair/action/booking_service_update_data.php",
					...
					function simpan(){
						...
						var user_input = "<?php echo $_SESSION['username']?>";
							...
							$.ajax({
								method : "post",
								url : "modul/service_general_repair/action/booking_service_insert_data.php",
