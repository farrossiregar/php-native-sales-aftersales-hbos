<?php
session_start();
 //if (strtoupper($_SESSION['leveluser']) != 'ADMIN' and $_SESSION['leveluser'] != 'supervisor' and strtoupper($_SESSION['leveluser']) != 'DRKSI' and strtoupper($_SESSION['leveluser']) != 'MNGR' and strtoupper($_SESSION['leveluser']) != 'SALESADM') {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle text-orange ">Masih Dalam Pengembangan</h1>
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									...
									<span class="mainDescription">Pengajuan Discount Supervisor</span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Showroom</span>
