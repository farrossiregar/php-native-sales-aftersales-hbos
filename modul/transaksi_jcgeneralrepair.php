						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<p class="progress-demo">
											<button type = "submit" class="btn btn-wide btn-primary ladda-button" data-style="expand-right" onclick=window.location.href='?module=sub_transaksi_jcgr&act=tambah';>
										...
										<div class="panel-body no-padding">
											<div class="tabbable no-margin no-padding">
												...
												<div class="tab-content">
													<div id="ariyanto" class="tab-pane padding-bottom-5 active">
																	...
																	<table class="table table-striped table-bordered table-hover table-full-width" id="sampl1">
																		...
																		<tbody>
																			...
																			<tr>
																				<?php 
																					$dt = new hitung_data;
																					$iu_ari = $dt->hitung_revenue_gr('ari',date("m-Y"));
																					$iu_ari_ = ($iu_ari[1]+$iu_ari[2])/$iu_ari[0];
																					$iu_ihsan = $dt->hitung_revenue_gr('ihsan',date("m-Y"));
																					$iu_ihsan_ = ($iu_ihsan[1]+$iu_ihsan[2])/$iu_ihsan[0];
																					$iu_suherman = $dt->hitung_revenue_gr('suherman',date("m-Y"));
																					$iu_suherman_ = ($iu_suherman[1]+$iu_suherman[2])/$iu_suherman[0];
																					$iu_taufik = $dt->hitung_revenue_gr('taufik',date("m-Y"));
																					$iu_taufik_ = ($iu_taufik[1]+$iu_taufik[2])/$iu_taufik[0];
																					$iu_wahyu = $dt->hitung_revenue_gr('wahyu',date("m-Y"));
																					$iu_wahyu_ = ($iu_wahyu[1]+$iu_wahyu[2])/$iu_wahyu[0];
																					$iu_yus = $dt->hitung_revenue_gr('yus',date("m-Y"));
																			...
																			<tr>	
																				<?php 
																					...
																					$efisien_ari = $dt->hitung_revenue_gr('ari',date("m-Y"));
																					$efisien_ari = $efisien_ari[0]/25;
																					$efisien_ihsan = $dt->hitung_revenue_gr('ihsan',date("m-Y"));
																					$efisien_ihsan = $efisien_ihsan[0]/25;
																					$efisien_suherman = $dt->hitung_revenue_gr('suherman',date("m-Y"));
																					$efisien_suherman = $efisien_suherman[0]/25;
																					$efisien_taufik = $dt->hitung_revenue_gr('taufik',date("m-Y"));
																					$efisien_taufik = $efisien_taufik[0]/25;
																					$efisien_wahyu = $dt->hitung_revenue_gr('wahyu',date("m-Y"));
																					$efisien_wahyu = $efisien_wahyu[0]/25;
																					$efisien_yus = $dt->hitung_revenue_gr('yus',date("m-Y"));
									...
									<form role="form" id="item_control" enctype="multipart/form-data" method="post" action="">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='?module=sub_transaksi_jcgr';>
