					...
					<div class="wrap-content container" id="container">
						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									...
									<span class="mainDescription">Pencapaian SPK Sales</span>
								</div>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<div class = "col-md-6">
									...
									<div class="form-group">
										...
										<form action = "<?php echo "$_SERVER[PHP_SELF]"; ?>" method = "GET">
											<input type = "hidden" name="module" value = "summary_penjualan_spk_sales" />
											<div class="form-group">
								...
								if($bulan !="-") { $faktur = mysql_query("select * from pesanan_kendaraan where bulan ='$bulan' ");
