											...
											<div class="tabbable no-margin no-padding">
												...
												<div class="tab-content">
												    ...
												    <?php 
												        ...
												        $tot_brio = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'BRIO' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $tot_mobilio = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'MOBILIO' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $tot_brv = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'BR-V' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $tot_hrv = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'HR-V' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $jazz       = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'JAZZ' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $city       = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'CITY' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $civic      = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'HIVIC' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $crv        = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'CR-V' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $accord     = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'ACCORD' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $odyssey    = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'ODYSSEY' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $crz        = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where model = 'CR-Z' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
													...
													//	$results = $res_ss1;
												        ...
												        $mbf = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where jenispenjualan = 'KREDIT' and kode_leasing = 'BLMR1' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $maf = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where jenispenjualan = 'KREDIT' and kode_leasing = 'MAF1' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $mtf = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where jenispenjualan = 'KREDIT' and kode_leasing = 'MTFSR1' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $may = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where jenispenjualan = 'KREDIT' and kode_leasing = 'MAYB1' and bulan ='$bulan' and kode_spv != 'OFFCE' ")); 
												        $bca = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where jenispenjualan = 'KREDIT' and kode_leasing = 'BCA L1' and bulan ='$bulan' and kode_spv != 'OFFCE' "));
												        $other = mysql_num_rows(mysql_query("select * from pesanan_kendaraan where jenispenjualan = 'KREDIT' and kode_leasing not in('BLMR1','MTFSR1','MAF1','MAYB1','BCA L1') and bulan ='$bulan' and kode_spv != 'OFFCE' "));
