										...
										<form action = "<?php echo "$_SERVER[PHP_SELF]"; ?>" method = "GET">
											...
											<div class="form-group">
												...
												<div class="input-group input-daterange datepicker" data-date-format='yyyy-mm-dd'>
													<input class="form-control" type="text" id="tgl_awal" name="tgl_awal" readonly>
														<span class="input-group-addon bg-primary">s/d</span>
													<input class="form-control" type="text" id="tgl_akhir" name="tgl_akhir" readonly>
												</div>
											</div>
											...
											<div class="tabbable no-margin no-padding">
												<ul class="nav nav-tabs" id="myTab">
													...
													//	$query = mysql_query("select * from target_spv where bulan = '$bulan' ");
														$query = mysql_query("select * from target_spv where bulan >= '$bulan' and bulan <= '$bulan' group by kode_spv order by kode_spv");
