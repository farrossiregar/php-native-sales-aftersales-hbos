											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="form-group">
														...
														<select name = "model" id="model_"  onchange="ajax_tampil_tipe();"  class = "form-control" required >														
													...
													<div class="form-group">
															...
															<select name="tipe_mobil" id = "tipe_" class = "form-control" onchange="ajax_tampil_warna();"  required >	
													...
													<div class="form-group">
														...
														<select name="warna" id="warna_" class = "form-control" >														
															...
															<?php 
														/*	$data = mysql_query("select * from warna");
																while ($r=mysql_fetch_array($data))
																{
																	echo "<option value=$r[kode_warna]> $r[nama_warna] </option>";
																}	*/
