...
date_default_timezone_set('Asia/Jakarta');
	...
	if($row > 0){ 
			...
			$no_spk = $data['no_spk'];
			$status_spv = $data['spv_app'];
			$spv_approve = $data['spv_user_app'];
			$status_mngr = $data['mngr_app'];
			$mngr_approve = $data['mngr_user_app'];
			$status_adm = $data['salesadm_app'];
			$adm_approve = $data['salesadm_user_app'];
			$status_finance = $data['mngr_finance_app'];
			$finance_approve = $data['mngr_finance_user_app'];
...
$html="
		...
		<table border='0' >
			...
			<tr>
				...
				<td style='width:10px;'>
					(".($status_spv == "Y" ? $spv_approve : "" ).")
				</td>
				<td style='width:10px;'>
					(".($status_mngr == "Y" ? $mngr_approve : "" ).")
				</td>
				<td style='width:10px;'>
					(".($status_adm == "Y" ? $adm_approve : "" ).")
				</td>
				<td style='width:10px;'>
				(".($status_finance == "Y" ? $finance_approve : "" ).")
				</td>
			</tr>
