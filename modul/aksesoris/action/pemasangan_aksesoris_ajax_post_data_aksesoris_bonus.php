...
<div  style="margin-bottom:10px">
	<input type="hidden" name="kode_accs_bonus[]" value = "<?php echo $data['kode_accessories']; ?>" class="form-control" readonly>
	<input type="text" name="accs_bonus[]" value = "<?php echo $data['nama_accessories']; ?>" class="form-control" readonly>
	<input type="hidden" name="accs_bonus_notransaksi[]" value = "<?php echo $data['nomor']; ?>" class="form-control" readonly>
	<input type="hidden" name="accs_bonus_supplier[]" value = "<?php echo $data['nama_supplier']; ?>" class="form-control" readonly>
