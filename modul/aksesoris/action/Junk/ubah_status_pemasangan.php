<?php
	...
	if(count($_POST)) {
				...
				if($_SESSION['leveluser']=='staff_logistik'){
						...
						mysql_unbuffered_query("update pemasangan_aksesoris set status_pasang = '$status_pemasangan_akhir' where no_spk = '$no_spk'");
				...
				for ($no = 0 ; $no <= $tot_bonus ;$no++){
					...
					mysql_unbuffered_query("update pemasangan_aksesoris_bonus set pemasangan = '$pemasangan_bonus',nomor_transaksi = '$no_transaksi',supplier = '$supplier' where id = '$id_bonus' ");
				...
				for ($no = 0 ; $no <= $tot_tambahan ;$no++){
					...
					mysql_unbuffered_query("update pemasangan_aksesoris_tambahan set pemasangan = '$pemesanan',nomor_transaksi = '$no_transaksi',supplier = '$supplier' where id = '$id' ");
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">
									<?php 
										if ($_GET[act] == 'ubahstatuspemasangan'){echo "Status Pemasangan Aksesoris";}
															...
															<div class="table-responsive">
																...
																<?php 
																	...
																	while ($data = mysql_fetch_array($query)){
																		...
																		$no_md ++;
																		$pemesanan = ($data['pemasangan'] == "Y" ? "checked" : "");
