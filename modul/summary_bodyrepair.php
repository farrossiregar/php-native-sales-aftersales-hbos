								...
								<div class = "col-md-6">
									...
									<div class="form-group">
										...
										<form action = "<?php echo "$_SERVER[PHP_SELF]"; ?>" method = "GET">
											<input type = "hidden" name="module" value = "sub_summary_bodyrepair" />
												...
												<div class="tab-content">
													<div id="asuransi" class="tab-pane padding-bottom-5 active">
														<div class="panel-scroll height-360">
																...
																$asuransi = $dt->tampil_asuransi($bulan);
													...
													<div id="fariz" class="tab-pane padding-bottom-5">
														<div class="panel-scroll height-360">
																...
																$dt = new hitung_persa;
																$fariz_care = $dt->sabp('fariz',$bulan,7);
																$fariz_revenue  = $dt->sabp('fariz',$bulan,23);
													...
													<div id="iqbal" class="tab-pane padding-bottom-5">
														<div class="panel-scroll height-360">
																...
																$iqbal_care = $dt->sabp('iqbal',$bulan,7);
																$iqbal_revenue  = $dt->sabp('iqbal',$bulan,23);
																?>
													...
													<div id="incentif" class="tab-pane padding-bottom-5">
														<div class="panel-scroll height-360">
															<?php
																	...
																	//Untuk FARIZ
																	$gt_care = $dt->data1('fariz',$bulan,7);
																	$gt_revenue = $dt->data1('fariz',$bulan,23);									
																	
																	$tot_point = $gt_care[0] + $gt_revenue[0];
																	$tot_ratio = ((($gt_revenue[1]*3)+$gt_care[1])/4);								
																	
																	
																	$jasabp = $dt->data2('fariz',$bulan);
																	...
																	$gt_care_iqbal = $dt->data1('iqbal',$bulan,7);
																	$gt_revenue_iqbal = $dt->data1('iqbal',$bulan,23);
																	
																	$tot_point_iqbal = $gt_care_iqbal[0] + $gt_revenue_iqbal[0];
																	$tot_ratio_iqbal = ((($gt_revenue_iqbal[1]*3)+$gt_care_iqbal[1])/4);
																	
																	$jasabp_iqbal = $dt->data2('iqbal',$bulan);
																	...
																	<table class="table table-striped table-bordered table-hover table-full-width" id="sampl1">
																		...
																		<tbody>
																			...
																			<tr>
																				...
																				<td></td>
																				<td></td>
																				<td><?php echo "Rp.".number_format(round(($jasapanel+$jasapanel_iqbal)/2,2),0,',','.'); ?></td>
																			</tr>												
