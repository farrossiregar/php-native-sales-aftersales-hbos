...
?>
								...
								<div class="col-md-12">
									<!--h5 class="over-title margin-bottom-15">Keseluruhan <span class="text-bold">Data Sales</span></h5-->
										...
										<p class="progress-demo">
											<button type = "submit" class="btn btn-wide btn-primary ladda-button" data-style="expand-right" onclick=window.location.href='?module=sub_transaksi_acchv&act=tambah';>
									...
									<hr>
									<?php include "hitung_incentif_gr.php"; ?>
									<h1 class="mainTitle text-orange "><u><?php echo "Incentive : Rp. ". number_format($final_incentive,0, ',', '.') ;  ?> </u></h1>
									<h1 class="mainTitle text-primary">Point Total : <?php echo number_format($point_total,0,',' ,'.') ." -- Ratio Total :". round($ratio_total_*100,2) ."%" ;  ?> </h1>
									<hr>
									<br />
									<!------------------------------------------------- EXTRA CARE --------------------------------->
												<?php
													...
													where itemcontrol.aktif = 'Y' and kategori.id_kategori = 1 and target_sa.bulan = '$bulan_sekarang' order by nm_item");
												...
												?>
									<?php $count = mysql_query("select count(id_item) as count from itemcontrol where id_kategori = '1' and aktif = 'Y'");
										$count = mysql_fetch_array($count);
									?>
									<h1 class="mainTitle">Extra Care <?php $ntotal = round($ntotal / $count['count'],2); echo " ($ntotal%) - $grandtotal_point"; ?>  </h1>
									...
									<!-----------------------------------------------------------PLUS PLUS ---------------------------->
												...
												<?php
													...
													left join kategori on itemcontrol.id_kategori = kategori.id_kategori 
													left join target_sa on itemcontrol.id_item = target_sa.id_item
													where itemcontrol.aktif = 'Y' and kategori.id_kategori = 2 and target_sa.bulan = '$bulan_sekarang' order by nm_item");
									...
									<?php $count = mysql_query("select count(id_item) as count from itemcontrol where id_kategori = '2' and aktif = 'Y'");
										$count = mysql_fetch_array($count);
									?>
									<h1 class="mainTitle">Plus + <?php $ntotal = round($ntotal / $count['count'],2); echo " ($ntotal%) - $grandtotal_point"; ?></h1>
									<hr />
									<div class = "table-responsive">
									...
									<!-----------------------------------------------------------ENGINE OIL ---------------------------->
												...
												<?php
													...
													left join kategori on itemcontrol.id_kategori = kategori.id_kategori 
													left join target_sa on itemcontrol.id_item = target_sa.id_item
													where itemcontrol.aktif = 'Y' and kategori.id_kategori = 3 and target_sa.bulan = '$bulan_sekarang' order by nm_item");
												...
												?>
									<?php $count = mysql_query("select count(id_item) as count from itemcontrol where id_kategori = '3' and aktif = 'Y'");
										$count = mysql_fetch_array($count);
									?>
									<h1 class="mainTitle">Engine Oil <?php $ntotal = round($ntotal / $count['count'],2); echo " ($ntotal%) - $grandtotal_point"; ?></h1>
									...
									<!-----------------------------------------------------------PART & CHEMICAL ---------------------------->
												...
												<?php
													...
													left join kategori on itemcontrol.id_kategori = kategori.id_kategori 
													left join target_sa on itemcontrol.id_item = target_sa.id_item
													where itemcontrol.aktif = 'Y' and kategori.id_kategori = 22 and target_sa.bulan = '$bulan_sekarang' order by nm_item");
												...
												?>
									<?php $count = mysql_query("select count(id_item) as count from itemcontrol where id_kategori = 22 and aktif = 'Y'");
										$count = mysql_fetch_array($count);
									?>
									<h1 class="mainTitle">Part & Chemical <?php $ntotal = round($ntotal / $count['count'],2); echo " ($ntotal%) - $grandtotal_point"; ?></h1>
									...
									<!----------------------------------------------------------- OTHERS ---------------------------->
												...
												<?php
													...
													left join kategori on itemcontrol.id_kategori = kategori.id_kategori 
													left join target_sa on itemcontrol.id_item = target_sa.id_item
													where itemcontrol.aktif = 'Y' and kategori.id_kategori = 4 and target_sa.bulan = '$bulan_sekarang' order by nm_item");
												...
												?>
									<?php $count = mysql_query("select count(id_item) as count from itemcontrol where id_kategori = 4 and aktif = 'Y'");
										$count = mysql_fetch_array($count);
									?>
									<h1 class="mainTitle">OTHERS <?php $ntotal = round($ntotal / $count['count'],2); echo " ($ntotal%) - $grandtotal_point"; ?></h1>
									...
									<!----------------------------------------------------------- REVENUE ---------------------------->
												...
												<?php
													...
													left join kategori on itemcontrol.id_kategori = kategori.id_kategori 
													left join target_sa on itemcontrol.id_item = target_sa.id_item
													where itemcontrol.aktif = 'Y' and kategori.id_kategori = 21 and target_sa.bulan = '$bulan_sekarang' order by nm_item");
												...
												?>
									<?php $count = mysql_query("select count(id_item) as count from itemcontrol where id_kategori = 21 and aktif = 'Y'");
										$count = mysql_fetch_array($count);
									?>
	...
	<?php 
		...
		if(count($_POST)) {
				$tot_package = $_POST[total]*$_POST[package_point];
			mysql_unbuffered_query("insert into acchv (tanggal,bulan,id_item,total,package_point,nm_sa,tgl_input) values('$tanggal','$bulan_post','$_POST[id_item]','$_POST[total]','$tot_package','$_SESSION[username]','$tgl_input')");
									...
									<form role="form" id="item_control" enctype="multipart/form-data" method="post" action="">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='?module=sub_transaksi_acchv';>
