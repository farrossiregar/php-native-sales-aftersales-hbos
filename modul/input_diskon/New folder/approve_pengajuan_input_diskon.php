<?php
	...
	mysql_unbuffered_query("update pengajuan_discount set disc_approved = '$disc_approved', status_approved = '$_POST[status_approved]', proses_approve = 'Y',user_approve = '$_SESSION[namalengkap]',tgl_approve = '$tgl' where no_pengajuan = '$_GET[id]'");
	...
	if ($_POST[status_approved] =="1"){
		...
		Pengajuan Diskon Ini Disetujui.
		</div>
		...
		<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
		<h4><i class='icon fa fa-check'></i> Selamat!</h4>
		Pengajuan Diskon Ini Tidak Disetujui.
		</div>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Setujui Pengajuan Discount</h1>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="media_showroom.php?module=sub_transaksi_pengajuan_discount&act=approvepengajuan&id=<?php echo $_GET[id]; ?>">
										<div class="row">
											<div class="col-md-12">
