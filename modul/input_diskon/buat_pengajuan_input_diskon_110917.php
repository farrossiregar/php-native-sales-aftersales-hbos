	...
	<?php 
		...
		if(count($_POST)) {
                        ...
                        mysql_unbuffered_query("insert into pengajuan_discount (no_pengajuan,no_spk,nama_customer,model,tipe_mobil,warna,harga_otr,discount_unit,pengajuan_disc,ket_discount,total_discount_accs,refund,total_discount,waktu,status_approved,cara_beli,leasing,tenor,pemohon,username_pemohon,nama_sales) 
							values('PD$nextNoTransaksi','$_POST[no_spk]','$_POST[nama_customer]','$_POST[model]','$_POST[tipe_mobil]','$_POST[warna]','$harga_otr','$discount_unit','$pengajuan_disc','$_POST[ket_discount]','$total_discount_accs','$refund','$total_discount','$_POST[waktu]','N','$_POST[cara_beli]','$_POST[leasing]','$_POST[tenor]','$_SESSION[namalengkap]','$_SESSION[username]','$_POST[nama_sales]')");
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<select name = "model" id="model" class = "form-control" required >														
    														<option value="semua_model" selected disabled>PILIH MODEL</option>
												...
												<div class="form-group">
    													...
    													<select name="tipe_mobil" id = "tipe_mobil" class = "form-control" required onchange = "harga_otomatis();" >	
    														<option value="semua_tipe" selected disabled >PILIH TIPE</option>
    													</select>
    											</div>
    												<div class="form-group">
    													<label for="form-field-select-2">
    													...
    													<select name="warna" id="warna" class = "form-control" required onchange = "harga_otomatis();" >														
    														<option value="semua_warna" selected disabled>PILIH WARNA</option>
												...
												<div class="radio clip-radio radio-primary radio-inline">
													<input type="radio" id="radio1" class="metodebayar" name="cara_beli" value="TUNAI" onclick="removereadonly();" required>
													<label for="radio1">
														Tunai
													</label>
												</div>
												<div class="radio clip-radio radio-primary radio-inline">
													<input type="radio" id="radio2" class="metodebayar" name="cara_beli" value="KREDIT" onclick="addreadonly();" required>
													<label for="radio2">
														Kredit
													</label>
												</div>
												<div class="radio clip-radio radio-primary radio-inline">
													<input type="radio" id="radio3" class="metodebayar" name="cara_beli" value="COP" onclick="removereadonly();" required>
													<label for="radio3">
														COP
													</label>
												</div>
												<div class="radio clip-radio radio-primary radio-inline">
													<input type="radio" id="radio4" class="metodebayar" name="cara_beli" value="GSO" onclick="removereadonly();" required>
													<label for="radio4">
														GSO
													</label>
												</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<span class="input-group-addon">Rp</span>
															<input type="text" class="form-control" id="discount_unit" required name="discount_unit" onkeypress="return hanyaAngka(event)" onKeyup="titikpemisah();"/>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label">
