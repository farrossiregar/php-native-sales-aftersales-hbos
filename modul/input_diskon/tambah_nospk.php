...
$disc_approved=str_replace(".","",$_POST['disc_approved']);
	...
	mysql_unbuffered_query("update pengajuan_discount set no_spk = '$_POST[no_spk]' where no_pengajuan = '$_GET[id]'");
									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="">
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="radio clip-radio radio-primary radio-inline" style = "display:none;">
													<input type="radio" id="radio1" name="status_approved" value="3" <?php if($status_approved=='AL'){echo 'checked';}?>>
													<label for="radio1">
														Ajukan ke Direktur
													</label>
												</div>
