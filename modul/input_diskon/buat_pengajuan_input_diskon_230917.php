										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<select name="tahun_buat" id="tahun_buat" class="form-control" required onchange = "harga_otomatis();" >
												...
												<div class="form-group">
													...
													<select name="promo_dealer" id="promo_dealer" class = "form-control" required onchange = "promo_dealer1();"  >														
