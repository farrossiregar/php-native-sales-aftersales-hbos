								...
								<div class="col-md-12">
									<!--h5 class="over-title margin-bottom-15">Keseluruhan <span class="text-bold">Data Sales</span></h5-->
										...
										<p class="progress-demo">
											<button type = "submit" class="btn btn-wide btn-primary ladda-button" data-style="expand-right" onclick=window.location.href='?module=sub_master_checklist_pameran&act=buat';>
												<span class="ladda-label"><i class="fa fa-plus"></i> Input Kategori Checklist Pameran</span>
											</button>	
										</p>
										<hr>
										<?php
...
<?php 
	break;
	case "buat":
	include "buat_checklist_pameran.php";
