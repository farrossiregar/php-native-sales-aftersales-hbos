									...
									<div class="panel panel-white no-radius">
										<div class="panel-body no-padding">
											...
											<?php
												...
												$total_cancel = $total_tdk_datang - $total_reschedule;
											...
											<script>
												...
												var total_cancel		= "<?php echo $total_cancel; ?>";
											...
											<div id="SUMMARY" class="tab-pane padding-bottom-5" >
															...
															<tr>
																		...
																		<?php
																			...
																			while ($file = mysql_fetch_array($query4)){
																				...
																				if ($jam != 0 or ($jam == 0 and $menit > 16) ){
																					...
																					if (($file['kedatangan'] == 'Y') or ($file['kedatangan'] == 'Sudah Service') or ($file ['jam_booking'] == '00:00:10')){
																	...
																	<td>
																	<?php
																	$total_cancel = $tot_tdk_datang - $tot_reschedule;
																	echo $total_cancel;
																	?>
																	</td>
																	<td>
														...
														?>
															...
															<tr>
																...
																<td>
																<?php
																$tot_cancel = $total_tdkkedatangan['total_tdkkedatangan']-$total_reschedule['total_reschedule'];
																echo $tot_cancel;
																?>
																</td>
																<td>
																	...
																	?>
																		<div class="progress-demo">
																			<a href='modul/service_summary_service/export_summary_booking.php?tgl_awal=<?php echo $_GET['tgl_awal'].'&tgl_akhir='.$_GET['tgl_akhir']; ?>' id="export">
													...
													<div id="SUMMARY_BOOKING" class="tab-pane padding-bottom-5" >
															<div class = "table-responsive">
																	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1" style= "text-align:center; border-collapse:collapse" >
																		<thead>
																			<tr>
																				...
																				<td>Booking Via</td>
																				<td>Keterangan</td>
																				<td>Konfirmasi Telp</td>												
																				<td>Konfirmasi Sms</td>
																				<td>Kedatangan</td>
																				<td>Jam Datang</td>																				
																				<td>Reschedule</td>												
																				<td>Keterangan Tidak Datang</td>
																				<td>User Input</td>
																				<td>Waktu Input
														...
														<?PHP
															$query5 = mysql_query("select * from booking_service where waktu_booking >= '$tgl_awal' and waktu_booking <= '$tgl_akhir' order by waktu_booking, jam_booking asc");
															$nomor = 1;
															while ($data = mysql_fetch_array($query5)){
														?>
															<tr>
														...
														?>
																	...
																	?>
																		<div class="progress-demo">
																			<a href='modul/service_summary_service/export_summary_booking_all.php?tgl_awal=<?php echo $_GET['tgl_awal'].'&tgl_akhir='.$_GET['tgl_akhir']; ?>' id="export">
																				<button class="btn btn-wide btn-primary ladda-button" data-style="expand-right" >
																					<span class="ladda-label"> Export Data ke Excel</span>
																				</button>
																			</a>
