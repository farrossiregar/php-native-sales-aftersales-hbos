			...
			?>
				...
				<tr>
					...
					<?php
						...
						while($data_tanggal_pengecekan = mysql_fetch_array($tanggal_pengecekan)){
							...
							$penilaian = mysql_query("SELECT hasil from pengecekan_service_detail where jam = '08:30' and nama_penilaian = '$data_master[nama_penilaian]' and substr(tanggal, 9, 2) = '$tgl_cek'");	
							$no = 0;
				...
				<tr>
					...
					<?php
						...
						while($data_tanggal_pengecekan = mysql_fetch_array($tanggal_pengecekan)){
							$tgl_cek = substr($data_tanggal_pengecekan['tanggal'], 8, 2);
							$penilaian = mysql_query("SELECT hasil from pengecekan_service_detail where jam = '13:30' and nama_penilaian = '$data_master[nama_penilaian]' and substr(tanggal, 9, 2) = '$tgl_cek'");	
							$no = 0;
							while($data_penilaian = mysql_fetch_array($penilaian)){
								$no = $no+1;
								if($data_penilaian['hasil'] == "Y"){
