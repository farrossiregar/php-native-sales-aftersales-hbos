							...
							<div class="row">
								...
								<?php
									...
									$tombol=$tombollogin;
											...
											$tombol3="
												 <a class='btn btn-xs btn-warning' href='modul/service_checklist/laporan_pengecekan_service.php?no_pengecekan_mingguan=$row[no_pengecekan_mingguan]' target='_BLANK' data-toggle='tooltip' data-original-title='Cetak Pengecekan $row[no_pengecekan_mingguan]' ><i class='fa fa-print'></i> CETAK</a>
												 "; 
											$tombol4="
												 <a class='btn btn-xs btn-warning' href='modul/service_checklist/export_pengecekan_service.php?bulan=$row[bulan]' data-toggle='tooltip' data-original-title='Ekspor Pengecekan $row[no_pengecekan_mingguan]' ><i class='fa fa-print'></i> Ekspor ke Excel</a>
												 "; 
										...
										<div class="row">
											...
											<div class="col-md-3">
												...
												<!--div style="padding :0px;" class="input-group input-daterange datepicker" data-date-format='yyyy-mm-dd'>
													<input class="form-control" type="text" id="tanggal_pengecekan" name="tanggal_pengecekan" onchange = "days();" readonly>
												</div-->
												<div class="form-group">
...
?>
			...
			<script>
				...
				function edit_catatan($id){
					...
					$.ajax({
						method : "post",
						url : "modul/service_checklist/data_edit_srv.php",
				...
				function edit_catatan_lain($id){
					...
					$.ajax({
						method : "post",
						url : "modul/service_checklist/data_edit_pengecekan_lain.php",
						data : "data_ajax="+no_id,
						success : function(data){
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body" style="background-color: white;">
														<form role="form" id="form" enctype="multipart/form-data" method="post" action="modul/service_checklist/update_data_pengecekan_srv.php" >
														<div class="row">
															<div class="col-md-12">
																<div class="row" hidden>
																	<div class="col-md-12">
...
<?php
	...
	include "approve_checklist_srv.php";
?>
