									...
									<table id="sample_1" class="table table-striped table-hover table-full-width">
										...
										<?php
											...
											while($row=mysql_fetch_array($query)){
												...
												$bulan_cek = substr($_GET['tgl_awal'], 5, 2).'-'.substr($_GET['tgl_awal'], 0, 4) ;
											...
											$tombol=$tombollogin;
												...
												$belum_diproses="
													 ...
													 ";
												$tombol3="
													 <a class='btn btn-xs btn-warning' href='modul/checklist_penampilan_sa/laporan_penampilan_sa.php?no_pengecekan_mingguan=$row[no_pengecekan_mingguan]' data-toggle='tooltip' data-original-title='Cetak Laporan Pengecekan $bulan_cek' ><i class='fa fa-print'></i> CETAK</a>
													"; 
												$tombol4="
													<a class='btn btn-xs btn-warning' href='modul/checklist_penampilan_sa/export_pengecekan_penampilan_sa.php?bulan=$bulan_cek' data-toggle='tooltip' data-original-title='Ekspor Pengecekan $bulan_cek' ><i class='fa fa-print'></i> Ekspor ke Excel</a>
													"; 
...
?>
			...
			<script>
				function edit_catatan($id){
					...
					$.ajax({
						method : "post",
						url : "modul/checklist_penampilan_sa/data_edit.php",
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body" style="background-color: white;">
														<form role="form" id="form" enctype="multipart/form-data" method="post" action="modul/checklist_penampilan_sa/update_data_pengecekan.php" >
														<div class="row">
															<div class="col-md-12">
...
<?php
	...
	include "modul/checklist_penampilan_sa/laporan_penampilan_sa.php";
?>
<?php				
