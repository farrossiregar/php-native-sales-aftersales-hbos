	<?php 
		...
		if(count($_POST)) {
                        ...
                        $cek_bulan=mysql_num_rows(mysql_query
                                     ("SELECT bulan FROM target_polesdua WHERE bulan='$bulan'"));
                        ...
                        // Kalau username valid, inputkan data ke tabel users
							...
							$data=mysql_query("select * from master_poles");
							$sql = $data;
							$number = 0;
							...
							$number += 1; 
								...
								mysql_unbuffered_query("INSERT INTO target_polesdua (grup, type, kode_item, nama_item, point, bulan) 
								VALUES ('$grup','$type','$kode_item','$nama_item','$point','$bulan')");
							}	
								$msg = "
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									...
									<span class="mainDescription">Masukkan Target Poles</span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Showroom</span>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="media_showroom.php?module=service_master_target_service_poles&act=buat">
										...
										<?php
									    	...
									    	<div class="col-md-2">
											    ...
											    <input type="text" style="text-transform:uppercase"  class="form-control" id="target" name="<?php echo 'type'.$number; ?>" value="<?php echo trim($data['type']); ?>"  required>
											...
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='media_showroom.php?module=service_master_target_service_poles';>
