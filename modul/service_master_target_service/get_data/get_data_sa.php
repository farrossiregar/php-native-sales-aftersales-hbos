												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" onkeypress="return hanyaAngka(event)" class="form-control" size="3" id="target" name="<?php echo 'target_unit'.$nomor; ?>" value="<?php echo ceil($data['target_unit'] / 7); ?>" required>
														</div>
														</div>
													<div class="col-md-6">
														<div class="form-group">
