	<?php 
		...
		if(count($_POST)) {
						...
						$bulan = $_POST['bulan'];
                        $sql=mysql_query("select * from master_target_sa_bp");
						
						
						
						
						$cek_bulan=mysql_num_rows(mysql_query("SELECT bulan FROM target_serviceadvisor_bp where nama_bp = '$nama_bp' and bulan = '$bulan'"));
						  ...
						  $msg = "							
							...
							while($data = mysql_fetch_assoc($sql)){
								...
								// Kalau username valid, inputkan data ke tabel users
								  ...
								  mysql_unbuffered_query("insert into target_serviceadvisor_bp (bulan,nama_bp,urutan,kode_item,nama_item,kode_kategori,nama_kategori,target_unit,target_point,program,fix_pembagi) 
									values('$bulan','$nama_bp','$urutan','$kode_item','$nama_item','$kode_kategori','$nama_kategori','$target_unit','$target_point','$program','$fix_pembagi')
									");
...
?>
				<script>
					function tgt_sa(){
						...
						$.ajax({
							method : "post",
							url : "modul/service_master_target_service/get_data/get_data_bp.php",
						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-8">
									...
									<span class="mainDescription">Masukkan Target SA BP</span>
								</div>
									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="">
										...
										<div class="col-md-12">
											...
											Pilih Service Advisor BP:
												...
												<option value="">--PILIH--</option>
												 ...
												 ?>
												 <option value="<?php echo $data['nama_bp']?>"><?php echo $data['nama_bp']?></option>
												 <?php
												 }
												 ?>
												 </select>
										...
										<div id="tampil_data_sa_bp">
											...
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='media_showroom.php?module=service_master_target_service_target_sa_bp';>
