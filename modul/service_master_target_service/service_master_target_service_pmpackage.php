...
?>
					...
					if(count($_POST['ubah'])) {
                        ...
                        $data=mysql_query("select * from target_pmpackagedua where bulan='$_POST[bulan]'");
					    $sql = $data;
						$number = 0;
                       ...
                       mysql_unbuffered_query("update target_pmpackagedua set point='$point' where kode_item='$kode_item' and bulan='$bulan'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Data Target PMPACKAGE</h1>
								...
								<div class="col-md-12">
									<!--h5 class="over-title margin-bottom-15">Keseluruhan <span class="text-bold">Data Sales</span></h5-->
										...
										<p class="progress-demo">
											<button type = "submit" class="btn btn-wide btn-primary ladda-button" data-style="expand-right" onclick=window.location.href='?module=service_master_target_service_pmpackage&act=buat';>
												<span class="ladda-label"><i class="fa fa-plus"></i> Input Target Pmpackage</span>
											</button>	
										</p>
										<hr>
										<?php
                                    ...
                                    <?php
                                    $query = "SELECT DISTINCT bulan FROM target_pmpackagedua";
                    ...
                    if(isset($_POST['cari'])){
                    	...
                    	$bulan=$_POST['bulan'];
						$kueri="SELECT * FROM target_pmpackagedua";
                    	if (empty($bulan)){
...
<?php 
	break;
	case "buat":
	include "input_target_pmpackage.php";
...
<?php 
	...
	if(count($_POST)) {
                      ...
                      mysql_unbuffered_query("update target_pmpackagedua set target_unit='$target_unit', target_point='$target_point' where id='$id' and bulan='$bulan'");
...
window.location = "media_showroom.php?module=service_master_target_service_pmpackage";
</script>;

<?php
    break;
    case "hapustarget":
    $sql 	= "delete from target_pmpackagedua where bulan ='$bulan'";
    $query	= mysql_query($sql);
   
		header('location:../media_showroom.php?module=service_master_target_service_pmpackage');
