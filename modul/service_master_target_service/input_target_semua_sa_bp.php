	<?php 
		...
		if(count($_POST)) {
                        ...
                        $cek_bulan=mysql_num_rows(mysql_query ("SELECT bulan FROM target_semua_sa_bp where bulan = '$bulan'"));
                        ...
                        // Kalau username valid, inputkan data ke tabel users
							...
							$data=mysql_query("select * from master_target_sa_bp");
							$sql = $data;
							$nomor = 0;
							while($data = mysql_fetch_array($sql)){
								...
								mysql_unbuffered_query("insert into target_semua_sa_bp (target_unit, target_point, nama_item, kode_item, kode_kategori,nama_kategori,urutan,bulan,program,fix_pembagi) 
								values ('$target_unit','$target_point','$nama_item','$kode_item','$kode_kategori','$nama_kategori','$urutan','$bulan','$program','$fix_pembagi')
								");
								
								//INSERT INTO `target_semua_sa` (`kode_item`, `nama_item`, `kode_kategori`, `nama_kategori`, `target_unit`, `target_point`, `program`, `urutan`, `bulan`, `id`) 
								//VALUES ('', '', '', '', '', '', 'STANDAR', '', '', NULL);
								//mysql_unbuffered_query("insert into target_semua_sa (kode_item,nama_item,kode_kategori,nama_kategori,target_unit,target_point,bulan,program,urutan) 
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									...
									<span class="mainDescription">Masukkan Target BP</span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Showroom</span>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="media_showroom.php?module=service_master_target_service_inc_bp&act=buat">
										...
										<?php
											...
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='media_showroom.php?module=service_master_target_service_inc_bp';>
