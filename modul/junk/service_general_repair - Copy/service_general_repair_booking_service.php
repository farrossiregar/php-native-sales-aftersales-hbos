...
?>
				...
				<?php include "modul/service_general_repair/action/booking_service_fungsi-fungsi.php"; 
												...
												<div class="col-md-12">
													...
													<div class="tabbable">
														<ul id="myTab1" class="nav nav-tabs">
															<li class="active">
																<a href="#data_pelanggan" data-toggle="tab">
																	Pelanggan
																</a>
															</li>
															<li>
																<a href="#jenis_service" data-toggle="tab">
																	Jenis Service
																</a>
															</li>
														...
														<div class="tab-content">
															<div class="tab-pane fade in active" id="data_pelanggan">
																																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group">
																			<label class="control-label">
																			...
																			<div class="input-group">
																				<input type="text" style="text-transform:uppercase" onblur="this.value=this.value.toUpperCase(); $('#src').click();" class="form-control" id="no_polisi" name="no_polisi" value="" required>
																...
																<div class="row">
																	<div class="col-md-12">
																		<div class="form-group">
																			...
																			<a href="#jenis_service" class="btn btn-primary btn-o next-step  pull-right show-tab">
															...
															<div class="tab-pane fade" id="jenis_service">
																<div class = "row">
																...
																<div class = "row">
																	...
																	<div id="waktu2">
																		<!--div class="col-md-6" id='tgl2'>
																			<div class="form-group">
																				<label class="control-label">
																					Pilih Periode 2 <span class="symbol required"></span>
																				</label>
																...
																<div class="row">
																	<div  id = "booking via">
																		...
																		<div class="col-md-8" style="display: none;" id="lain_lain">
																			<div class="form-group">
																				<label class="control-label">
																					Keterangan
																				</label>
																...
																<div class="row">
																	<div class="col-md-12">
																		<div class="form-group">
																			...
																			<a href="#data_pelanggan" class="btn btn-primary btn-o next-step  pull-right show-tab" id="ke_pelanggan">
