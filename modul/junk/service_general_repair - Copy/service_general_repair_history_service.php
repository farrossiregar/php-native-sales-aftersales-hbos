...
$(document).ready(function(){
	$('#src').click(function(){
		...
		if (nopolisi != ""){
			...
			$.ajax({
					method : "post",
					url : "modul/service_general_repair/action/history_service_tampil_data.php",
					...
					success : function(data){
						...
						$.ajax({
							method : "post",
							url : "modul/service_general_repair/action/history_service_listhistory.php",
							data : 	'nopolisi='+nopolisi,
							success : function(data){
	...
	$('#btnlihatdetailhistory').click(function(){
		...
		if (norangka != ""){
			...
			$.ajax({
				method : "post",
				url : "modul/service_general_repair/action/history_service_tampildetailhistory.php",
				data : 	'nopolisi='+nopolisi,
				success : function(data){
					$("#Modal2").modal('show');
