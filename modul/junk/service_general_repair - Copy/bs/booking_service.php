					...
					function tambah_data(){
						$.ajax({
							...
							//	$('#tgl_booking').val("").attr("disabled", false);
								$('#tgl_booking').val("").prop("disabled", false);
					...
					/*	function tambah_data(){
						$.ajax({
							...
							success : function(data){
								$.ajax({
									method : "post",
									url : "modul/service_general_repair/tambah_data_booking.php",
									success : function(data){
										$("Modal2").modal('show');
										$('#myModal2Label').html("Tambah Booking Stock");
										$('#modal_booking').html(data);
					...
					function edit_modal($id){
						...
						$.ajax({
							...
							/*	var dd = data.toString();
								...
								$('#no_booking').val(dat[0]).prop("readonly", true);								
								$('#nama_cust').val(dat[1]).prop("readonly", true);
								$('#tgl_booking').val(dat[3]).attr("disabled", true);
								$('#jam_booking').val(dat[2]).attr("disabled", true);
								$('#no_polisi').val(dat[4]).prop("readonly", true);
								$('#tipe').val(dat[5]).attr("disabled", true);
								$('#telepon').val(dat[6]).prop("readonly", true);
					...
					//	===============	UPDATE	============================
						...
						$('#upd').on('click', function(){
							...
							$.ajax({
								...
								data : 'data_update='+no_booking+'&data9='+datang+'&data10='+jam_datang+'&data11='+reschedule+'&data12='+ket_tidak_datang,
								success : function(data){
									$('#nama_cust').val("");
									$('#tgl_booking').val("");
									$('#jam_booking').val("");
					...
					function simpan(){
						...
						if($('#nama_cust').val("")){
							$.ajax({
								...
								data: 'data='+no_booking+'&data1='+nama+'&data2='+jam+'&data3='+tanggal+'&data4='+no_polisi+'&data5='+tipe+'&data6='+telepon+'&data7='+perbaikan+'&data8='+keterangan2+'&data9='+user_input,
								success : function(data){
									$('#no_booking').val("");
									$('#nama_cust').val("");
									$('#jam_booking').val("");
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="input-group input-daterange datepicker" data-date-format='yyyy-mm-dd D'>
																	<input class="form-control" type="text" id="tgl_booking" name="tgl_booking" onchange="pilih_hari();" onload = "pilih_hari();" value ="<?php echo date(Y-m-d); ?>" readonly required >
																</div>
															</div>
														</div>
														<div class="col-md-6">
