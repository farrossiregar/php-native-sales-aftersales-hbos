...
?>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						function cek_input_pengajuan_ulang() {
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="modul/pengajuan_diskon1/simpan_pengajuan_ulang.php"  onsubmit ="return cek_input_pengajuan_ulang();">
										<div class="row">
											<div class="col-md-12">
											...
											<?php 
												...
												$data2 = mysql_query("select t.nama_tipe as nama_tipe, w.nama_warna as nama_warna, m.nama_model as nama_model ,pd.* from pengajuan_discount_ulang pd 
																	...
																	left join model m on m.kode_model=pd.model
																	left join warna w on w.kode_warna=pd.warna
																	where pd.no_pengajuan='$_GET[id]' order by pd.nomor ");
											...
											<div class="panel panel-white collapses" id="panel5">
												...
												<div class="form-group">
    													...
    													<select name="tipe_mobil" id = "tipe_mobil" class = "form-control" required onchange = "harga_otomatis('ulang');" >	
												...
												<script>
													...
													$("#ikut_asuransi").hide();
														...
														$.ajax({
															method : "post",
															url : "modul/pengajuan_diskon/get_promo.php",
															data : {data_ajax : isipd},
															success : function(data){
												...
												function tampil_leasing(){
													...
													//alert(isipd);
														...
														$.ajax({
															method : "post",
															url : "modul/pengajuan_diskon/get_tampil_leasing.php",
															data : {data_ajax : isipd},
															success : function(data){
														...
														$.ajax({
																method : "post",
																url : "modul/pengajuan_diskon/get_tampil_asuransi.php",
																data : {data_ajax : isipd},
																success : function(data){
