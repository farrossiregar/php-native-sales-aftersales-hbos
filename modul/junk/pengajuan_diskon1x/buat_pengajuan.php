						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="modul/pengajuan_diskon1/simpan_pengajuan.php" onsubmit ="return cek_input_pengajuan_diskon();">
										<div class="row">
											<div class="col-md-12">
