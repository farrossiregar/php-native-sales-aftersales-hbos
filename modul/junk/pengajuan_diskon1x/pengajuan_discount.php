               ...
               <script language="JavaScript">
				...
				<div class="main-content" >
                    ...
                    if(isset($_GET['status_approved'])){
						            ...
						            $tombol=$tombollogin;
    									if($tombol=="admin") {
    									    $tombol="$plafondisc
    								         ...
    								         <a class='btn btn-xs btn-warning' href='modul/pengajuan_diskon1/laporan_pengajuan_discount_2.php?id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a>
    									...
    									if($tombol=="salesadm") {
    									    if ($data['status_approved'] == "Y" ){
    									        ...
    									        $tombol="<a class='btn btn-xs btn-warning' href='modul/pengajuan_diskon1/laporan_pengajuan_discount_2.php?id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a>"; 
												}else {
													$tombol = "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>
						...
						<a href='modul/pengajuan_diskon1/eks_pd.php?status_approved=<?php echo $_GET[status_approved].'&tgl_awal='.$tanggal_awal.'&tgl_akhir='.$tanggal_akhir; ?>'>
