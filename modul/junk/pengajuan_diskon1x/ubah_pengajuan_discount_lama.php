									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="">
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<option value='ACCORD' <? if($r[model]=='ACCORD'){echo 'selected';}?>>Accord</option>
													<option value='BR-V' <? if($r[model]=='BR-V'){echo 'selected';}?>>BR-V</option>
													<option value='BRIO' <? if($r[model]=='BRIO'){echo 'selected';}?>>Brio</option>
													<option value='CITY' <? if($r[model]=='CITY'){echo 'selected';}?>>City</option>
													<option value='CIVIC' <? if($r[model]=='CIVIC'){echo 'selected';}?>>Civic</option>
													<option value='CR-V' <? if($r[model]=='CR-V'){echo 'selected';}?>>CR-V</option>
													<option value='CR-Z' <? if($r[model]=='CR-Z'){echo 'selected';}?>>CR-Z</option>
													<option value='FREED' <? if($r[model]=='FREED'){echo 'selected';}?>>Freed</option>
													<option value='HR-V' <? if($r[model]=='HR-V'){echo 'selected';}?>>HR-V</option>
													<option value='JAZZ' <? if($r[model]=='JAZZ'){echo 'selected';}?>>Jazz</option>
													<option value='MOBILIO' <? if($r[model]=='MOBILIO'){echo 'selected';}?>>Mobilio</option>
													<option value='ODYSSEY' <? if($r[model]=='ODYSSEY'){echo 'selected';}?>>Odyssey</option>
												    </select>
												</div>
												<div class="form-group">
													<label class="control-label">
													...
													<input type="text" placeholder="Tipe" class="form-control" id="tipe_mobil" name="tipe_mobil" value="<?php echo $r[tipe_mobil]; ?>">
												</div>
												<div class="form-group">
													<label class="control-label">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-left" onclick=window.location.href='?module=prospek_pengajuandiscount';>
