				...
				<script>
							...
							var isipd = $('#nospk').val();
								...
								$.ajax({
									...
									success : function(data){
										...
										var dat = d.split(",");
										$('#nospk').val(isipd);
										$('#tipe_mobil').val(dat[0].trim());
										$('#warna').val(dat[1]);
										$('#customer').val(dat[2]);
										$('#cara_bayar').val(dat[3]);
										$('#leasing').val(dat[4]);
										$('#tenor').val(dat[5]);
										$('#disc').val(dat[6]);
									}
								...
								*/
								$.ajax({
									method : "post",
									url : "modul/permohonan_unit_keluar/ajax_pembayaran.php",
									data : {data : isipd},
									success : function(data){
										$('#depe').html(data);
									}
					...
					function post() {
						...
						tbody.onclick = function (e) {
							...
							x.value = dt_split[0].trim();
								$.ajax({
									method : "post",
									url : "modul/permohonan_unit_keluar/ajax_post_data_spk.php",
					...
					function tampil_modal(){
						...
						$.ajax({
									method : "GET",
									url : "modul/permohonan_unit_keluar/ajax_list_spk.php",
									data : {data_ajax : x.value},
									success : function(data){
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									<form role="form" id="form" enctype="multipart/form-data" method="post" action="modul/permohonan_unit_keluar/simpan_permohonan_unit_keluar.php">
										<div class="row">
											<div class="col-md-12">
