									...
									<form role="form" id="form" name="form" enctype="multipart/form-data" method="post" action="modul/pengajuan_diskon/simpan_pengajuan.php" onsubmit ="return cek_input_pengajuan_diskon();">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='media_showroom.php?module=sub_transaksi_pengajuan_discount';>
