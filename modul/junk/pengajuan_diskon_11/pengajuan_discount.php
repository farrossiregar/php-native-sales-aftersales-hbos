    									...
    									if($tombol=="salesadm") {
    									    if ($data['status_approved'] == "Y" ){
    									        ...
    									        $tombol="<a class='btn btn-xs btn-warning' href='modul/pengajuan_diskon/laporan_pengajuan_discount_2.php?id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a>"; 
													...
													$tombol = "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>
															<a class='btn btn-xs btn-info' href='media_showroom.php?module=sub_transaksi_pengajuan_discount&act=tambahdetail&id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> ISI NO SPK</a>
											";
    									...
    									if($tombol=="MNGR") {
    								        ...
    								        if ($data['proses_approve'] == "N" and $data['status_approved'] != "AL"){
    										    ...
    										    //$tombol = "<!--a class='btn btn-xs btn-warning' href='modul/laporan_pengajuan_discount_2.php?id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a-->";
    										      $tombol = " <a class='btn btn-xs btn-warning' href='media_showroom.php?module=sub_transaksi_pengajuan_discount&act=pengajuan_ulang&id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Ubah Pengajuan $data[no_pengajuan]'><i class='fa fa-edit'></i> Pengajuan Ulang </a>
																<a class='btn btn-xs btn-info' href='media_showroom.php?module=sub_transaksi_pengajuan_discount&act=tambahdetail&id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> UBAH STATUS PENGAJUAN</a>
						                    ...
						                    if($tombol=="user") {
												if ($proses_approve == 'Y'){
													...
													$tombol = "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>";	
														...
														//<a class='btn btn-xs btn-warning' href='media_showroom.php?module=sub_transaksi_pengajuan_discount&act=pengajuan_ulang&id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Ubah Pengajuan $data[no_pengajuan]'><i class='fa fa-edit'></i> Pengajuan Ulang </a> ";
