...
date_default_timezone_set('Asia/Jakarta');
	...
	$kueri = mysql_query("select * FROM pengajuan_discount_ulang where no_pengajuan='$_GET[id]'");
...
// MULAI JOIN NAMA, TIPE DAN WARNA MODEL
	...
	// TUTUP JOIN NAMA, TIPE DAN WARNA MODEL
		...
		if ($double =='Y' ){
		    ...
		    left join tipe t on t.kode_tipe=pd.tipe_mobil 
		    left join model m on m.kode_model=pd.model left join warna w on w.kode_warna=pd.warna where pd.no_pengajuan='$_GET[id]' ";
