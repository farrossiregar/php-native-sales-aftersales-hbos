...
?>	
               ...
               <script language="JavaScript">
					...
					function ajax_tampil_tipe(){
						...
						$.ajax({
							method : "post",
							url : "modul/alokasi_unit_hpm/ajax_tampil_tipe.php",
								...
								<div class="col-md-3">
									<!--h5 class="over-title margin-bottom-15">Keseluruhan <span class="text-bold">Data Sales</span></h5-->
										...
										<p class="progress-demo">
											<button type = "submit" class="btn btn-wide btn-primary ladda-button" data-style="expand-right" onclick=window.location.href='?module=sub_transaksi_alokasi_unit_hpm&act=buat';>
								...
								<div class="row">
									<div class="col-md-3">								
										<div class="form-group">
											...
											<input type = "hidden" name = "module" value = "sub_transaksi_alokasi_unit_hpm" />		
							...
							<?php
								...
								<tr>
									...
									<td>
										...
										if($_SESSION['leveluser'] != 'supervisor'){ echo "<a class='btn btn-xs btn-primary' href='media_showroom.php?module=sub_transaksi_alokasi_unit_hpm&act=booking_alokasi&kode_tipe=$kode_tipe&kode_warna=$dt[kode_warna]&jumlah_booking=$dt[jumlah_booking]'
									...
									<form role="form" id="form" enctype="multipart/form-data" method="post" action="">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-left" onclick="window.location.href='?module=sub_transaksi_alokasi_unit_hpm';">
									...
									<form role="form" id="form" enctype="multipart/form-data" method="POST" action="">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick="window.location.href='?module=sub_transaksi_alokasi_unit_hpm';">
													<span class="ladda-label"><i class="fa fa-mail-reply"></i> Keluar </span>
												</button>
											</div>
										</div>
