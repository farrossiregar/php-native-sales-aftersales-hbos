				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Prospek</h1>
									<span class="mainDescription">Pengajuan Diskon</span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Showroom</span>
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<div class="row">
								<div class="col-md-12">
									 <?php if($cek_akses2['tambah_data'] == 'Y')
										    {
												?>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body" style="background-color: white;">
												...
												<div class="col-md-12">								
													<div class="form-group">
														...
														<select id="status_approved" class="form-control" name="status_approved" >
										...
										<div class="modal-footer" style="background-color: white;">
											<button type="submit" id="tampil_data" name="cari" class="btn btn-primary">Tampilkan Data</button>
											<button type="button" class="btn btn-primary btn-o" data-dismiss="modal">
												Close
											</button>
										</div>
							...
							<div class="row">
								<div class="col-md-4">
							Jumlah data <select id="batas" name="batas" onchange="tampil();" >
							...
							<?php
									...
									if ($rec_pengu >0 ){
    								    ...
    								    if($plafondisc >= $disc_bruto1) {
											if ($data['leasing'] == '(KKB) BCA'){
												$plafondisc = "<a class='btn btn-xs btn-danger' href='media_showroom.php?module=prospek_pengajuandiscount&act=ajukanapprove&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Pengajuan $data[no_pengajuan] Total Diskon Melebihi Plafon Diskon'><i class='fa fa-check'></i> AJUKAN KE DIREKTUR</a>";
											}else {
												$plafondisc="<a class='btn btn-xs btn-success' href='media_showroom.php?module=prospek_pengajuandiscount&act=approvepengajuan&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-check'></i> BERI PERSETUJUAN</a>"; 
											}
    								...
    								$direkturapprove=$data['status_approved'];
    									if($direkturapprove=="AL") {
    										$direkturapprove="<a class='btn btn-xs btn-success' href='media_showroom.php?module=prospek_pengajuandiscount&act=approvepengajuan&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-check'></i> BERI PERSETUJUAN</a>"; 
						            ...
						            $tombol=$tombollogin;
    									if($tombol=="admin") {
    									    $tombol="$plafondisc
    								         ...
    								         <a class='btn btn-xs btn-warning' href='modul/prospek/action/pengajuandiscount_cetak.php?id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a>
    									    ...
    									    if ($data['proses_approve'] == "N"){
											   ...
											   if ($no_spk == ""){
												   if ($data['status_approved'] == "Y" ){
												 	   $tombol="<a class='btn btn-xs btn-info' href='media_showroom.php?module=prospek_pengajuandiscount&act=tambahdetail&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> UBAH STATUS PENGAJUAN</a>"; 
												   }else {
													   $tombol = "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>";
												   }
    									...
    									if($tombol=="salesadm") {
    									    if ($data['status_approved'] == "Y" ){
    									        ...
    									        $tombol="<a class='btn btn-xs btn-warning' href='modul/prospek/action/pengajuandiscount_cetak.php?id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a>"; 
												}else {
													$tombol = "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>
															<a class='btn btn-xs btn-info' href='media_showroom.php?module=prospek_pengajuandiscount&act=tambahdetail&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> ISI NO SPK</a>
											";
    									...
    									if($tombol=="MNGR") {
    								        ...
    								        if ($data['proses_approve'] == "N" and $data['status_approved'] != "AL"){
    										    ...
    										    //$tombol = "<!--a class='btn btn-xs btn-warning' href='modul/laporan_pengajuan_discount_2.php?id=$data[no_pengajuan]' data-placement='top' data-toggle='tooltip' data-original-title='Cetak Pengajuan $data[no_pengajuan]' target='_blank'><i class='fa fa-print'></i> CETAK</a-->";
    										      $tombol = " <a class='btn btn-xs btn-warning' href='media_showroom.php?module=prospek_pengajuandiscount&act=pengajuan_ulang&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Ubah Pengajuan $data[no_pengajuan]'><i class='fa fa-edit'></i> Pengajuan Ulang </a>
																<a class='btn btn-xs btn-info' href='media_showroom.php?module=prospek_pengajuandiscount&act=tambahdetail&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Setujui Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> UBAH STATUS PENGAJUAN</a>
						                ...
						                if($tombol=="DRKSI") {
						                    ...
						                    if($tombol=="user") {
												if ($proses_approve == 'Y'){
													...
													$tombol = "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>";	
														...
														$tombol= "<a class='btn btn-xs btn-primary' onclick = 'tampil_lihat_detail($no);' data-placement='top' data-toggle='tooltip' data-original-title='Lihat Detail Pengajuan $data[no_pengajuan]'><i class='fa fa-book'></i> LIHAT DETAIL DATA</a>
														<a class='btn btn-xs btn-warning' href='media_showroom.php?module=prospek_pengajuandiscount&act=pengajuan_ulang&id=".md5(md5($data[no_pengajuan]))."' data-placement='top' data-toggle='tooltip' data-original-title='Ubah Pengajuan $data[no_pengajuan]'><i class='fa fa-edit'></i> Pengajuan Ulang </a> ";
											...
											?>
												...
												<td width='30%'>
													...
													include "action/pengajuandiscount_lihatapprove.php";
...
<?php 
	break;
	case "buat":
	include "action/pengajuandiscount_buat.php";
...
<?php	
	...
	include "action/pengajuandiscount_ulang.php";
...
<?php	
	break;
	case "tambahdetail":
	include "action/pengajuandiscount_tambah_nospk.php";
...
<?php	
	...
	if($_SESSION['leveluser'] == 'MNGR' or $_SESSION['leveluser'] == 'DRKSI'  or $_SESSION['leveluser'] == 'admin'){
		include "action/pengajuandiscount_approve.php";
	}else{
		include "modul/protected.php";
	}
