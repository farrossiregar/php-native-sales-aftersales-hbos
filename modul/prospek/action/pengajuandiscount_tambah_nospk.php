<?php
	...
	if(count($_POST)) {
		...
		if ($_POST[status_spk] == "Y"){
			mysql_unbuffered_query("update pengajuan_discount set tgl_spk = '$_POST[tgl_spk]', no_spk = '$_POST[no_spk]',status_spk = '$_POST[status_spk]',ket_tidakspk = '$_POST[ket_tidakspk]' where md5(md5(no_pengajuan)) = '$_GET[id]'");
			
		}else {
			mysql_unbuffered_query("update pengajuan_discount set no_spk = '',status_spk = '$_POST[status_spk]',ket_tidakspk = '$_POST[ket_tidakspk]' where md5(md5(no_pengajuan))='$_GET[id]'");
		}
...
<?php 
												$data2 = mysql_query("select * from pengajuan_discount_ulang where md5(md5(no_pengajuan))='$_GET[id]' ");
