									...
									<table id="sample_1" class="table table-hover table-full-width">
										...
										<?php
											...
											$tombol=$tombollogin;
												...
												$tombol3="
													 <a class='btn btn-xs btn-warning' href='modul/checklist_showroom/laporan_pengecekan_showroom.php?no_pengecekan_mingguan=$row[no_pengecekan_mingguan]' data-toggle='tooltip' data-original-title='Cetak Laporan Pengecekan $_GET[tgl_awal]' ><i class='fa fa-print'></i> CETAK</a>
													"; 
												$tombol4="
													 <a class='btn btn-xs btn-warning' href='modul/checklist_showroom/export_pengecekan_showroom.php?bulan=$_GET[tgl_awal]' data-toggle='tooltip' data-original-title='Ekspor Pengecekan $bulan' ><i class='fa fa-print'></i> Ekspor ke Excel</a>
													 "; 
...
<?php
	...
	if(count($_POST)) {
		...
		if($keterangan_lain != ''){
			mysql_query("insert into pengecekan_showroom_detail_lain (no_pengecekan_mingguan, no_pengecekan, jam, tanggal, hasil, catatan_pengecekan) 
