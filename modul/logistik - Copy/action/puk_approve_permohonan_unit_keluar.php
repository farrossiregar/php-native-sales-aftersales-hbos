		...
		if($_SESSION['leveluser']=='supervisor' or $_SESSION['leveluser']=='admin'){
			...
			if($r['mngr_app']=='Y'){
				...
				if ($persetujuan == "Y"){
					...
					mysql_unbuffered_query("update unit_keluar set set spv_app = '',mngr_app = '',status_approved = '$persetujuan_akhir',ket_approved = '$ket_approved', salesadm_app = '$persetujuan', salesadm_user_app = '$_SESSION[namalengkap]', salesadm_app_time='$app_time' where md5(md5(no_spk)) = '$_GET[id]'");
				}
			...
			if($r['salesadm_app']=='Y'){
				...
				if ($persetujuan == "Y"){
					...
					mysql_unbuffered_query("update unit_keluar set set spv_app = '',mngr_app = '',salesadm_app = '',status_approved = '$persetujuan_akhir',ket_approved = '$ket_approved', mngr_finance_app = '$persetujuan', mngr_finance_user_app = '$_SESSION[namalengkap]', mngr_finance_app_time='$app_time' where md5(md5(no_spk)) = '$_GET[id]'");
				}
