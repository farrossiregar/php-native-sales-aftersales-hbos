    									...
    									<div class="panel panel-white">
    										...
    										<div id="collapseOne" class="panel-collapse collapse">
    											...
    											<div class="col-md-6">
    												...
    												<input type = "hidden" name = "module" value = "logistik_lihatstock" />
												 ...
												 if ($r[nomatching]!=''){
													 ...
													 if ($r['tglmatching'] < "$tgllalu" and $alokasifaktur == "Belum Faktur" ){
														...
														if ($r['norangka_local']!=''){
															if ($_SESSION[leveluser]=='supervisor'){
															    ...
															    if ($r['fix']=='N')
																{
																    ...
																    echo "<div style=color:darkorchid;>
																            ...
																            By: ".$nama[nama_lengkap]."<br /> <a href='media_showroom.php?module=logistik_lihatstock&act=ubahbook&id=$r[norangka]'> [Ubah Data]</a> | <a onclick='return konfirmasi()' href='modul/action/logistik_lihatstockbatal.php?id=$r[norangka]'> [Batal Booking]</a></div>";
																}   
																else
																{
																    $tampilnama	=mysql_query("SELECT * FROM users WHERE username='$r[user]'");
															...
															$tombol_booking = "<a class='btn btn-xs btn-primary' href='media_showroom.php?module=logistik_lihatstock&act=tambah&id=$r[norangka]' data-placement='top' data-toggle='tooltip' data-original-title='Booking Norangka $r[norangka]'><i class='fa fa-car'></i> Booking No Rangka</a>";
															$tombol_fakturfiktif = "<a class='btn btn-xs btn-success' href='media_showroom.php?module=logistik_lihatstock&act=fakturfiktif&id=$r[norangka]' data-placement='top' data-toggle='tooltip' data-original-title='Booking Norangka $r[norangka]'><i class='fa fa-book'></i>  Set Faktur Fiktif</a>";
														    if (trim($r['bisabooking']) =='Y'){
														    	
																echo $tombol_booking;
																//echo "<a href='media_showroom.php?module=logistik_lihatstock&act=tambah&id=$r[norangka]'>Booking No Rangka</a>";
																
																if ($_SESSION[leveluser]=='admin' or $_SESSION[leveluser]=='salesadm' or $_SESSION[leveluser]=='MNGR' )
														        {		
																	
																	echo "   ".$tombol_fakturfiktif; 
																	//echo "<a href='media_showroom.php?module=logistik_lihatstock&act=fakturfiktif&id=$r[norangka]'> / Faktur Fiktif</a>";
														        }
														    }
														    else
														    {
															...
															if ($_SESSION[leveluser]=='supervisor'){
															    ...
															    if ($r['fix']=='N')
																{
																    ...
																    echo "<div style=color:darkorchid;>
																            ...
																            Nama Customer : ".$r[nama_customer_local]." <br />
																            Jenis Pembayaran : ".$jenispembayaran." <br />
																            By: ".$nama[nama_lengkap]."<br /> <a href='media_showroom.php?module=logistik_lihatstock&act=ubahbook&id=$r[norangka]'> [Ubah Data]</a> | <a onclick='return konfirmasi()' href='modul/logistik/action/logistik_ubahdata_bookstock.php?id=$r[norangka]'> [Batal Booking]</a></div>";
																}   
																else
																{
																    $tampilnama	=mysql_query("SELECT * FROM users WHERE username='$r[user]'");
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<form role="form" id="form" enctype="multipart/form-data" method="POST" action="modul/logistik/action/logistik_bookingstock.php?module=logistik_lihatstock&act=tambah">
										<div class="row">
											<div class="col-md-12">
											<?php echo(isset ($msg) ? $msg : ''); ?>
												<div class="errorHandler alert alert-danger no-display">
										...
										<div class="row">											
											<div class="col-md-4">
												...
												<button type = "button" class="btn btn-wide btn-danger ladda-button" data-style="expand-right" onclick=window.location.href='?module=logistik_lihatstock';>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<form role="form" id="form___" enctype="multipart/form-data" method="POST" action="media_showroom.php?module=logistik_lihatstock&act=ubahbook&id=<?php echo $_GET[id]; ?>">
										<div class="row">
											<div class="col-md-12">
											<?php echo(isset ($msg) ? $msg : ''); ?>
												<div class="errorHandler alert alert-danger no-display">
