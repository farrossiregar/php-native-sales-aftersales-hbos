								...
								<tr>
									...
									<td>
										...
										<div class="progress-demo">
											...
											<?php if ($_SESSION[leveluser] == 'admin' || $_SESSION[leveluser] == 'salesadm' || $_SESSION[leveluser] == 'staff_salesadm' || $_SESSION[leveluser] == 'supervisor' || $_SESSION['leveluser'] == 'mngr_finance' || $_SESSION['leveluser'] == 'ar_finance' || $_SESSION['leveluser']== 'spv_finance' || $_SESSION['leveluser']== 'staff_logistik')
											...
											?>
											<a class='btn btn-xs btn-success' href='media_showroom.php?module=logistik_puk&act=update&id=<?php echo md5(md5($dt['no_spk'])); ?>' data-placement='top' data-toggle='tooltip' data-original-title='Ubah data <?php echo $dt['no_puk'] ?>'><i class='fa fa-edit'></i> Ubah Data</a>
											...
											<?php
												...
												/*	if($mngr_app == 'Y'){
														...
														$button_type = 'danger';
														$button_name = 'Belum Diproses oleh Manager';
													}	*/
													...
													if($spv_app == 'Y'){
														...
														$button_type = 'danger';
														$button_name = 'Belum Diproses oleh Supervisor';
													}
												...
												if($_SESSION['leveluser'] == 'admin' || $_SESSION['leveluser'] == 'supervisor' || $_SESSION['leveluser'] == 'MNGR' || $_SESSION['leveluser'] == 'salesadm' || $_SESSION['leveluser'] == 'staff_salesadm' || $_SESSION['leveluser'] == 'mngr_finance' || $_SESSION['leveluser'] == 'staff_logistik'){
											?>
