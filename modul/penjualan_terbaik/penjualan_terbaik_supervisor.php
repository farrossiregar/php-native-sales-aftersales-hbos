						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<div class = "col-md-6">
									...
									<div class="form-group">
										...
										<form action = "<?php echo "$_SERVER[PHP_SELF]"; ?>" method = "GET">
											<input type = "hidden" name="module" value = "penjualan_terbaik_supervisor" />
											<div class="form-group">
								...
								<div class="col-sm-12">
													...
													<div class="tab-pane padding-bottom-5 <?php if ($kode_spvtarget == 'HENRI'){echo "active";} ?>"> 
													<divs class="tab-pane padding-bottom-5"> 
																	...
																	<table class="table table-striped table-bordered table-hover table-full-width" id="sampl1" style= "text-align:center;" >
																		...
																		<tbody>
																		    <?php 
																				...
																				$query_spv = mysql_query("SELECT  count(sf.kode_spv) as num, (round(count(sf.kode_sales)/tsp.target_unit*100)) as pencapaian, 
																				sf.*, tsp.* FROM summary_faktur sf, target_spv tsp WHERE sf.kode_spv  = tsp.kode_spv and sf.bulan = tsp.bulan and 
																				sf.bulan= '$bulan' group by sf.kode_spv order by pencapaian desc limit 3");
																			        while ($spv = mysql_fetch_array($query_spv))
																			        {
																			           
																					   $kdspv = $spv['kode_spv'];
																			           $target = $spv['target_unit'];
																					   $pencapaian = $spv['pencapaian'];
																				...
																				<!--td style="font-size:17px;">
    																				...
    																				/*
    																				    ...
    																				    */
																						...
																						$where = "select * from summary_faktur where kode_spv = '$kdspv' and bulan = '$bulan' "; 
    																				    $total = mysql_query($where);
    																				    $total = mysql_num_rows($total);
    																				    echo "<b>$total</b>";
																					...
																					<?php
																						...
																						$gmb=mysql_query("select * from users where kode_supervisor='$kdspv' and level='supervisor'");
																						if (mysql_num_rows($gmb) >=1){
																							$gmb_rec = mysql_fetch_assoc($gmb);
																							$foto1 = trim($gmb_rec['foto']);
																						}else{
																						...
																						if($pencapaian>='50'){
																							if($pencapaian<='65'){
																								echo "<td>
																									  ...
																									  <td>
																										Kode Supervisor : ".$kdspv."</br>
																										Pencapaian : <span class='label label-danger'>".$pencapaian." %</span>
																									</td>";
																							}elseif($pencapaian>='65' && $pencapaian <'100'){
																								echo "<td>
																										<img src='image/medium_".$foto1."'>
																									  </td>
																									  <td>
																										Kode Supervisor : ".$kdspv."</br>
																										Pencapaian : <span class='label label-warning'>".$pencapaian." %</span>
																									</td>";
																							}else{
																								echo "<td>
																										<img src='image/medium_".$foto1."'>
