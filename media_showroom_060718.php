				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
							...
							<li class="dropdown">
								<?php 
									if ($_SESSION['leveluser']=='admin' ||  $_SESSION['leveluser']=='MNGR' ||  $_SESSION['leveluser']=='mngr_bengkel' ||  $_SESSION['leveluser']=='DRKSI'){
								?>
							...
							<li class="dropdown">
								<?php 
									if ($_SESSION['leveluser']=='admin' or $_SESSION['leveluser']=='HRD' or ($_SESSION['leveluser']=='supervisor' and $_SESSION['username']=='supervisor' ) or ($_SESSION['leveluser']=='supervisor' and $_SESSION['username']=='sudi123' )){
								?>
